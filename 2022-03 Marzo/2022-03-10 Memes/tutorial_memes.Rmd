...
Para este tutorial/laboratorio, vamos a usar las capacidades de R para entrar a Twitter para descargar memes en español publicados en las últimas horas. 
...
str_c("imagenes_bien/", list.files("imagenes_bien/")) %>%
  ...
  image_animate(fps=2) %>% # Anima las imagenes, con 1 segundo entre imágenes.
